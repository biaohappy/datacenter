 ...
 */
@Data
public class Response1<T> implements Serializable {
    ...
    public Response1(T result) {
        this.success = true;
        this.result = result;
    }

    public Response1(boolean flag, T result) {
        if(flag) {
            this.success = true;
            this.result = result;
        } else {
    ...
    public Response1(String errorCode) {
        this.success = false;
        this.errorCode = errorCode;
    }

    public Response1(String errorCode, String errorMsg) {
        this.errorCode = errorCode;
    ...
    public boolean equals(Object o) {
        if(this == o) {
            ...
            Response1 response = (Response1)o;
